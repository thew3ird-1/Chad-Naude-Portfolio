...
// Using raw SVGs for portability without extra npm packages
...
export const GitlabIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m22.65 14.39-10.66 7.74a.9.9 0 0 1-1 0L.35 14.39a.88.88 0 0 1-.32-.96l1.23-3.8 2.59-8a.46.46 0 0 1 .42-.26h.02a.46.46 0 0 1 .42.28L8 11.75h8l3.29-10.1a.46.46 0 0 1 .42-.28h.02a.46.46 0 0 1 .42.26l2.59 8 1.23 3.8a.88.88 0 0 1-.32.96Z"/>
  </svg>
);
